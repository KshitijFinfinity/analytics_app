...
ALTER TABLE IF EXISTS events DROP CONSTRAINT IF EXISTS events_project_id_fkey;
ALTER TABLE IF EXISTS events ALTER COLUMN project_id TYPE TEXT USING project_id::text;
